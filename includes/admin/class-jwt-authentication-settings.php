...
use WP_Core_Plugin\Authentication\Jwt_Authentication_Api;
...
class Jwt_Authentication_Settings
{
	...
	{
		$secret_key = Jwt_Authentication_Api::get_key();
		$is_global  = Jwt_Authentication_Api::is_global('JWT_AUTHENTICATION_SECRET_KEY');
	...
	{
		$enable_cors = Jwt_Authentication_Api::get_cors();
		$is_global   = Jwt_Authentication_Api::is_global('JWT_AUTHENTICATION_CORS_ENABLE');
